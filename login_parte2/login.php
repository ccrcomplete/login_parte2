    ...
    <div class="container-fluid">
        <div class="row justify-content-md-center">
            <div class="col-md-5 d-flex justify-content-end">
                <div class="animationSec col-md-2 align-items-start">
                    <div class="backg">
                        <div class="planet">
                            <div class="r1"></div>
                            <div class="r2"></div>
                    ...
                    <form class="d-flex flex-column w-75" method="POST">
                        <div class="row mb-4">
                            ...
                            <div class="col">
                                ...
                                <input type="password" name="pass" id="pass" class="form-control" aria-label="pass">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col d-grid">
                                <button type="submit" name="submit" class="btn btn-dark py-2 text-uppercase">Login</button>
                            </div>
                        </div>
                    </form>
                </div>
